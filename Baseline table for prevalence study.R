...
for (pp in 1:length(prevalence)){ ##Iterations for each prevalence
  ...
  ALPmedian[pp] = median(ALP)
  TLPmedian[pp] = median(TLP)
  ALPlowerquantile[pp] = quantile(ALP, probs = 0.025,names = FALSE)
  TLPlowerquantile[pp] = quantile(TLP, probs = 0.025,names = FALSE)
  ALPupperquantile[pp] = quantile(ALP, probs = 0.975,names = FALSE)
  TLPupperquantile[pp] = quantile(TLP, probs = 0.975,names = FALSE)
